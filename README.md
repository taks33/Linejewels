...
psql "$SUPABASE_DB_URL" -f supabase/seed.sql         # 38 produits, 38 variantes, 27 photos
```
...
- **27 photos** : bagues, bracelets et boucles d'oreilles complets (9/9 chacun) —
  servies depuis `public/produits/`. Restent les colliers et les lunettes.
...
- [ ] Photos des 11 produits restants, et bascule des photos vers Supabase Storage
