...
psql "$SUPABASE_DB_URL" -f supabase/seed.sql         # 38 produits, 38 variantes, 26 photos
```
...
- **26 photos** : bagues et boucles d'oreilles complètes (9/9), bracelets 8/9 —
...
- [ ] Photos des 12 produits restants, et bascule des photos vers Supabase Storage
