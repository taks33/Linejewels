...
psql "$SUPABASE_DB_URL" -f supabase/seed.sql         # 38 produits, 38 variantes, 16 photos
```
...
- **16 photos** : bagues et boucles d'oreilles 8 sur 9 chacune (il manque l'argent),
...
- [ ] Photos des 22 produits restants, et bascule des photos vers Supabase Storage
