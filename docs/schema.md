...
| `product_images` | Photos, `is_primary` pour la vignette de la grille. | 42 |
...
- **Photos** : les 36 bijoux ont leur couverture ; cinq bagues ont en plus un porté
  (et l'argent, un plan de la parure). Servies depuis `public/produits/`.
